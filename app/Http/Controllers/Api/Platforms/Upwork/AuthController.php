...
namespace App\Http\Controllers\Api\Platforms\Upwork;

use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Services\Upwork\AuthService;
...
class AuthController extends Controller
{
     ...
     */
    public function redirectToProvider(Request $request, ?string $ipUuid = null)
    {
        try {
            $user = auth('api')->user();
            $platform_slug = 'upwork';
            ...
            $sessionId = uniqid('oauth_up_', true);
    ...
    public function handleCallback(Request $request)
    {
        try {
            ...
            $platformSlug = $payload['platform_slug'] ?? 'upwork';
