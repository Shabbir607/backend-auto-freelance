...
export const Starfield = () => {
    ...
    useEffect(() => {
        ...
        // Optimization: Cap pixel ratio at 2 for mobile performance
        ...
        const render = () => {
            ...
            stars.forEach((star) => {
                const depth = star.z;
                // Reduce parallax effect on mobile for better performance/less disorientation
        ...
        // Add touch support for star movement
