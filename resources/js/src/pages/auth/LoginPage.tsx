...
import { Box, ChevronRight, Eye, EyeOff, Loader2, Lock, Mail } from 'lucide-react';
...
// ==========================================
// 1. VISUAL FX COMPONENTS (Reused from Theme)
// ==========================================
        ...
        <div className="w-full max-w-md relative z-20 py-12">
          ...
          <SpotlightCard className="p-8 shadow-2xl">
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold mb-2 text-white">Access Terminal</h1>
              <p className="text-sm text-slate-400">Enter your credentials to continue building.</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="#" className="text-xs text-indigo-400 hover:text-indigo-300 transition-colors">Forgot?</Link>
                </div>
                <div className="relative group">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-indigo-400 transition-colors">
            ...
            {/* <div className="mt-6 text-center text-sm">
              <span className="text-slate-500">New to Nexus? </span>
