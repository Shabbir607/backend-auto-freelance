...
const EyeOff = ssr.createLucideIcon("EyeOff", [
...
const HookFormControlContext = ssr.React2.createContext(null);
...
const useIsomorphicLayoutEffect = typeof window !== "undefined" ? ssr.React2.useLayoutEffect : ssr.React2.useEffect;
...
const HookFormContext = ssr.React2.createContext(null);
...
function useForm(props = {}) {
  const _formControl = ssr.React2.useRef(void 0);
  const _values = ssr.React2.useRef(void 0);
  const [formState, updateFormState] = ssr.React2.useState({
    isDirty: false,
    isValidating: false,
  ...
  ssr.React2.useEffect(() => control._disableForm(props.disabled), [control, props.disabled]);
  ...
  _formControl.current.formState = ssr.React2.useMemo(() => getProxyFormState(formState, control), [control, formState]);
