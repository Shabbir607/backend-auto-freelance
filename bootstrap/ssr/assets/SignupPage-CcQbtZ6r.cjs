...
const signupSchema = types.objectType({
  name: types.stringType().min(2, "Name must be at least 2 characters"),
  email: types.stringType().email("Invalid email address"),
  password: types.stringType().min(8, "Password must be at least 8 characters"),
      ...
      /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md relative z-20 py-12", children: [
        ...
        /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs(SpotlightCard, { className: "p-8 shadow-2xl", children: [
          /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-2 text-white", children: "Initialize Account" }),
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400", children: "Join the network to start building." })
          ] }),
          /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-5", children: [
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(label.Label, { htmlFor: "name", className: "text-slate-400 text-xs font-medium uppercase tracking-wider", children: "Full Name" }),
              /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-indigo-400 transition-colors", children: /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(ssr.User, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(
                  ssr.Input,
                  {
                    id: "name",
              ...
              errors.name && /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("p", { className: "text-xs text-red-400 flex items-center gap-1 mt-1", children: [
            ...
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(label.Label, { htmlFor: "confirmPassword", className: "text-slate-400 text-xs font-medium uppercase tracking-wider", children: "Confirm Password" }),
              /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-indigo-400 transition-colors", children: /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(lock.Lock, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(
                  ssr.Input,
                ...
                /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: "absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-300 transition-colors",
                    children: showConfirmPassword ? /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(types.EyeOff, { className: "w-4 h-4" }) : /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(ssr.Eye, { className: "w-4 h-4" })
                  }
                )
              ] }),
              errors.confirmPassword && /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("p", { className: "text-xs text-red-400 flex items-center gap-1 mt-1", children: [
                /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("span", { className: "w-1 h-1 rounded-full bg-red-400" }),
                " ",
          ...
          /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("p", { className: "mt-4 text-[10px] text-center text-slate-500", children: [
            "By registering, you agree to our",
            " ",
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("a", { href: "#", className: "text-indigo-400 hover:underline", children: "Terms of Service" }),
            " ",
            "and",
            " ",
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("a", { href: "#", className: "text-indigo-400 hover:underline", children: "Privacy Policy" })
          ] }),
          /* @__PURE__ */ ssr.jsxRuntimeExports.jsxs("div", { className: "mt-6 text-center text-sm", children: [
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "Already have an account? " }),
            /* @__PURE__ */ ssr.jsxRuntimeExports.jsx(ssr.distExports.Link, { to: "/login", className: "text-indigo-400 hover:text-indigo-300 font-medium transition-colors hover:underline", children: "Sign in" })
          ] })
        ] })
      ] })
    ] }),
