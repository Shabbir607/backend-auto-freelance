...
function CourseDetailsPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PublicNavbarLayout, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SEOHelmet, { title: course.title, description: course.description }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-[#0a0a0a] text-neutral-200", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "relative pt-32 pb-24 px-6 border-b border-white/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto relative z-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => navigate("/courses"), className: "flex items-center gap-2 text-sm text-neutral-500 hover:text-white mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-4 h-4" }),
          " Back to Courses"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "border-blue-500/30 text-blue-400 bg-blue-500/10 uppercase font-bold px-3 py-1", children: [
              course.level,
              " Level"
            ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6", children: course.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-neutral-400 mb-10 leading-relaxed max-w-2xl", children: course.description }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-6 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto grid lg:grid-cols-12 gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-8 space-y-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-white mb-8", children: "Course Syllabus" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: sortedModules.map((module, idx) => {
              const isExpanded = expandedModules.includes(module.id);
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-white/10 rounded-2xl bg-[#111111] overflow-hidden", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    onClick: () => setExpandedModules((prev) => isExpanded ? prev.filter((id2) => id2 !== module.id) : [...prev, module.id]),
                    className: "w-full flex items-center justify-between p-6 text-left",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-sm font-bold", children: idx + 1 }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-white", children: module.title }) })
                      ] }),
                      isExpanded ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronUp, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-5 h-5" })
                    ]
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: { height: 0 }, animate: { height: "auto" }, exit: { height: 0 }, className: "overflow-hidden bg-[#0a0a0a] border-t border-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3", children: module.lessons?.sort((a, b) => a.order - b.order).map((lesson, lIdx) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => navigate(`/${course.slug}/${lesson.slug}`), className: "w-full flex items-center justify-between p-4 rounded-xl hover:bg-white/5 text-left", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-neutral-600", children: [
                    lIdx + 1,
                    "."
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlay, { className: "w-4 h-4 text-blue-400" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: lesson.title })
                ] }) }, lesson.id)) }) }) })
              ] }, module.id);
            }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-10 border-t border-white/10", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl font-bold text-white mb-8", children: "Student Reviews" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-[#111111] border-white/10 mb-10 rounded-2xl p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-xl font-semibold text-white mb-6", children: "Rate this course" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleReviewSubmit, className: "space-y-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: [1, 2, 3, 4, 5].map((star) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: () => setRating(star), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: `w-8 h-8 ${star <= rating ? "fill-amber-500 text-amber-500" : "text-neutral-700"}` }) }, star)) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "text", value: reviewTitle, onChange: (e) => setReviewTitle(e.target.value), className: "w-full h-12 rounded-xl border border-white/10 bg-black/50 px-4 text-white", placeholder: "Review Title", required: true }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Textarea, { value: reviewComment, onChange: (e) => setReviewComment(e.target.value), className: "w-full min-h-[120px] rounded-xl border border-white/10 bg-black/50 p-4 text-white", placeholder: "Your review", required: true }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", disabled: isSubmittingReview, className: "bg-white text-black font-semibold px-8 h-12 rounded-xl", children: "Post Review" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: reviews.map((review) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-2xl bg-white/[0.03] border border-white/5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-neutral-400 text-sm", children: review.comment })
            ] }, review.id)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-4 relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-28", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "bg-[#111111] border-white/10 rounded-3xl p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0a0a0a] border border-white/10 rounded-2xl p-6 flex flex-col items-center justify-center text-center mb-8", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "lg", onClick: () => navigate(`/${course.slug}/${sortedModules[0]?.lessons[0]?.slug}`), className: "w-full bg-blue-600 hover:bg-blue-700 text-white h-14 rounded-xl font-bold text-base", children: "Enroll Now" })
        ] }) }) })
      ] }) })
    ] })
  ] });
