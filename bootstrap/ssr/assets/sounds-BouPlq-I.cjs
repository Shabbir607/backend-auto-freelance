...
function requireHowler() {
  ...
  (function(exports$1) {
    (function() {
      ...
      if (typeof ssr.commonjsGlobal !== "undefined") {
        ssr.commonjsGlobal.HowlerGlobal = HowlerGlobal2;
        ssr.commonjsGlobal.Howler = Howler2;
        ssr.commonjsGlobal.Howl = Howl2;
        ssr.commonjsGlobal.Sound = Sound2;
