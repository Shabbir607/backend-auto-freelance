import { d as distExports, r as reactExports, b5 as useForm, j as jsxRuntimeExports, n as Box, aa as User, e as Mail, b6 as Lock, b7 as EyeOff, I as Eye, L as LoaderCircle, C as ChevronRight, b8 as t, b9 as objectType, ba as stringType } from "./vendor-oSjIcCqY.js";
...
function SignupPage() {
  ...
  const onSubmit = async (data) => {
    ...
    if (result.success) {
      ...
      showToast("message" in result ? result.message || "Registration failed." : "Registration failed. Please try again.", "error");
    }
  };
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-md relative z-20 py-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SpotlightCard, { className: "p-8 shadow-2xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-2 text-white", children: "Initialize Account" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-slate-400", children: "Join the network to start building." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "name", className: "text-slate-400 text-xs font-medium uppercase tracking-wider", children: "Full Name" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-indigo-400 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
                  {
                    id: "name",
              ...
              errors.name && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-red-400 flex items-center gap-1 mt-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { htmlFor: "confirmPassword", className: "text-slate-400 text-xs font-medium uppercase tracking-wider", children: "Confirm Password" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within:text-indigo-400 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Input,
              ...
              errors.confirmPassword && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-red-400 flex items-center gap-1 mt-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1 h-1 rounded-full bg-red-400" }),
                " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-[10px] text-center text-slate-500", children: [
            "By registering, you agree to our",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-indigo-400 hover:underline", children: "Terms of Service" }),
            " ",
            "and",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#", className: "text-indigo-400 hover:underline", children: "Privacy Policy" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 text-center text-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-500", children: "Already have an account? " }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(distExports.Link, { to: "/login", className: "text-indigo-400 hover:text-indigo-300 font-medium transition-colors hover:underline", children: "Sign in" })
          ] })
        ] })
      ] })
    ] }),
