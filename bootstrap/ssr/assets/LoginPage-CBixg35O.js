...
import { Box, Mail, Lock, EyeOff, Eye, Loader2, ChevronRight } from "lucide-react";
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-full max-w-md relative z-20 py-12", children: [
        ...
        /* @__PURE__ */ jsxs(SpotlightCard, { className: "p-8 shadow-2xl", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-center mb-8", children: [
            /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold mb-2 text-white", children: "Access Terminal" }),
            /* @__PURE__ */ jsx("p", { className: "text-sm text-slate-400", children: "Enter your credentials to continue building." })
          ] }),
          /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit(onSubmit), className: "space-y-5", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center", children: [
                ...
                /* @__PURE__ */ jsx(Link, { to: "#", className: "text-xs text-indigo-400 hover:text-indigo-300 transition-colors", children: "Forgot?" })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "relative group", children: [
