import { cq as Radio, cr as Truck, cs as Wrench, D as Star, O as Smartphone, $ as Server, ct as Home, a8 as BookOpen, bD as Activity, cu as PieChart, cv as CreditCard, cw as ShoppingBag, cx as Headphones, cy as Image, bg as Video, as as MessageCircle, cz as Brain, bE as Target, ao as TrendingUp, cA as DollarSign, N as FileText, aN as Shield, R as Settings, f as Globe, s as MessageSquare, u as Share2, y as Search, a0 as Calendar, U as Users, e as Mail, B as BarChart3, cB as PenTool, cC as CodeXml, cD as Megaphone, cE as Briefcase, Z as Zap, m as Bot, ae as Sparkles, J as Layers, j as jsxRuntimeExports, r as reactExports, z as Filter, q as GitBranch, b1 as CircleCheckBig, I as Eye, P as Plus } from "./vendor-oSjIcCqY.js";
import { c as cn, a as useToast, I as Input, B as Button, C as Card, d as Badge, D as Dialog, j as DialogContent, k as DialogHeader, l as DialogTitle, m as DialogDescription, n as DialogFooter, w as workflowService } from "../ssr.js";
import "stream";
import "util";
const iconMap = {
  // Common Categories
...
function DynamicIcon({ name, className, fallback = Layers }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(IconComponent, { className: cn("shrink-0", className) });
}
